...
if( window == top ){
                ...
                var syncLocalStorageFromUrl = 'NA';
        ...
        if(!isSecured && syncLocalStorageFromUrl !== 'NA')
        ...
        function syncLocalStorage(event) {
            ...
            if (syncLocalStorageFromUrl === 'NA' || syncLocalStorageFromUrl.split('://')[1].indexOf(event.origin.split('://')[1]) === -1){
    ...
    function setValues(obj) {
        if (obj) {
            if (obj.tier1) {
                ...
                if (similarproducts.testBucket != 'uiABTest') {
                    dataObj.tier1_bucket = ((similarproducts.b.qsObj && similarproducts.b.qsObj.bucket ) || (window.qsObj && window.qsObj.bucket )) || obj.tier1.bucket;                
                }
            ...
            if (obj.tier2) {
                ...
                if (similarproducts.testBucket != 'uiABTest') {
                    dataObj.tier2_bucket = ((similarproducts.b.qsObj && similarproducts.b.qsObj.bucket ) || (window.qsObj && window.qsObj.bucket )) || obj.tier2.bucket;
                }                
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!similarproducts.b.qsObj.dlsource) {
            similarproducts.b.qsObj.dlsource = "rlwkwkm";
        }
    ...
    return {
        ...
        if (!similarproducts.utilities.blacklistHandler.isWSBlacklist() && !similarproducts.utilities.blacklistHandler.isPageBlacklist() || !similarproducts.utilities.blacklistHandler.isCPNBlacklist()) {
            if (similarproducts.b.qsObj.dlsource && similarproducts.b.qsObj.dlsource == 'sfrvzr' && Math.floor((Math.random()*2)+1) == 1) {
                similarproducts.testBucket = 'uiABTest';
                similarproducts.b.qsObj.bucket = similarproducts.testBucket;
                ...
                if (similarproducts.b.qsObj.dlsource && similarproducts.b.qsObj.dlsource == 'sfrvzr') {
                    similarproducts.testBucket = 'uiABTestControl';
                    similarproducts.b.qsObj.bucket = similarproducts.testBucket;
                }
                similarproducts.b.inj(window.document, "https://www.superfish.com/ws/sf_code.jsp" + similarproducts.b.initialQS, 1);
            }
